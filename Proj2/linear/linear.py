...
class Linear(Module):
    ...
    def __init__(self, in_features, out_features):
        ...
        self.init_parameters()  # Fill parameters with random

    def init_parameters(self):
        # Fill parameters with random number, std epsilon
    ...
    def backward(self, dl_ds):
        # Compute derivatives and stock them for optimisation step
        self.dl_ds = dl_ds
